      ...
      <div className="flex flex-col h-full">
        ...
        <header className="relative flex items-center flex-shrink-0 h-16 bg-white">
          ...
          <div className="absolute inset-y-0 left-0 md:static md:flex-shrink-0">
            <a
              href="#"
              className="flex items-center justify-center w-16 h-16 bg-mx-positive-red focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-600 md:w-20"
            >
              <Image
                alt="Workflow"
